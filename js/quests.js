...
function nbt(type,nbt,n,i) {
    ...
    for (let x in data[n][i][`${type}`].nbt) {
        if (x == 'name') {
            ...
            quest_start = `## quest ${data[n][i][`${type}`].nbt.quest_id}<br># start<br>tellraw @s ["",{"text":"\n[","color":"dark_gray"},{"text":"♦","color":"gold"},{"text":"] ","color":"dark_gray"},{"text":"Quest started! ","color":"gold"},{"text":"${data[n][i][`${type}`].nbt.name}\n","color":"yellow"}]`;
...
function parse_advancement(criteria,quest_id,quest_advancement,quest_end_check,quest_end,item) {
    ...
    quest_end = `${quest_end}## quest ${quest_id}<br>tellraw @s ["",{"text":"\n[","color":"dark_gray"},{"text":"♦","color":"gold"},{"text":"] ","color":"dark_gray"},{"text":"Quest finished! ","color":"gold"},{"text":"${item.nbt.name}","color":"yellow"}]`;
